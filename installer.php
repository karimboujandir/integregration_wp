...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Boujandirkarim_integrationvin_ec503bfb6aef1df25524_20230206155130_archive.zip';
        const ARCHIVE_SIZE       = '111487574';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ec503bf-06155130';
        const SECONDARY_PACKAGE_HASH = '1eac058-06155130';
